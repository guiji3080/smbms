...
<div class="right">
       ...
       <div class="search">
       <form method="get" action="${pageContext.request.contextPath }/bill/findByPage">
			<span>商品名称：</span>
      ...
      <table class="providerTable" cellpadding="0" cellspacing="0">
          ...
          <c:forEach var="bill" items="${billList.pageList}" varStatus="status">
				<tr>
					<td>
			...
			<ul class="page-num-ul clearfix">
				<li>共${billList.totalCount }条记录&nbsp;&nbsp; ${billList.pageNo }/${billList.totalpages }页</li>
				<li>	
					<a href="${pageContext.request.contextPath}/bill/findByPage?pageNo=1&queryProductName=${queryProductName}&queryProviderId=${queryProviderId}&queryIsPayment=${queryIsPayment}">首页</a>
					<a href="${pageContext.request.contextPath}/bill/findByPage?pageNo=${billList.pageNo-1}&queryProductName=${queryProductName}&queryProviderId=${queryProviderId}&queryIsPayment=${queryIsPayment}">上一页</a>
					<a href="${pageContext.request.contextPath}/bill/findByPage?pageNo=${billList.pageNo+1}&queryProductName=${queryProductName}&queryProviderId=${queryProviderId}&queryIsPayment=${queryIsPayment}">下一页</a>
					<a href="${pageContext.request.contextPath}/bill/findByPage?pageNo=${billList.totalpages}&queryProductName=${queryProductName}&queryProviderId=${queryProviderId}&queryIsPayment=${queryIsPayment}">最后一页</a>
				&nbsp;&nbsp;
				</li>	
			</ul>
